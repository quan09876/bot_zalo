class Logging:
    ...
    def logged(self, text: str) -> None:
        text = str(text)
        print(f"{self.green} {self.log_text_color}LOGGED IN {self.reset} {self.textcolor}{text}")
    
    def added(self, text: str) -> None:
        text = str(text)
        print(f"{self.magenta} {self.log_text_color}ADDED {self.reset} {self.textcolor}{text}")
    ...
    def prefixcmd(self, text: str) -> None:
        text = str(text)
        print(f"{self.blue} {self.log_text_color}PREFIX COMMANDS BOT {self.reset} {self.textcolor}{text}")
